...
export function FullScreenLoader({
  ...
  return (
    <div className="absolute inset-0 z-[9999] bg-background/90 backdrop-blur-2xl flex flex-col items-center justify-center gap-8 animate-in fade-in duration-300 min-h-[400px]">
