...
async function main() {
    ...
    console.log("✅ Users created:", { admin: admin.id, faculty1: faculty1.id, student1: student1.id, student2: student2.id });
    ...
    console.log("✅ Courses created:", { course1: course1.id, course2: course2.id });
